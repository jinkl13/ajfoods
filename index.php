...
<section class="hidden-bar">
	...
	<div class="inner-box">
		...
		<div class="logo-box">
		<a href="index.html" title="Aj foods"><img src="images/logo aj.png" alt="" title="AJ FOODS"></a></div>
		...
		<h2>Visit Us</h2>
		<ul class="info">
			<li>7/355, AJ Foods, Vellorkkodath, Rockwell Road,<br></li>
			<li>kollamprambu Canal Road,
			HMT Colony P.O, Kalamassery - 683104</li>
			<li><a href="mailto:ajgroup0202@gmail.com">ajgroup0202@gmail.com</a></li>
		</ul>
		<div class="separator"><span></span></div>
		<div class="booking-info">
			<div class="bk-title">Booking request</div>
			<div class="bk-no">
				<a href="tel:+917356 567 693,+919037 087 022">+917356 567 693,+919037 087 022</a></div>
		</div>
...
<section class="info-bar">
	<div class="inner-box">
		...
		<div class="booking-info">
			<div class="bk-title">Booking request</div>
			<div class="bk-no">
				<a href="+917356 567 693,+919037 087 022">+917356 567 693,+919037 087 022</a></div>
		</div>
	</div>
</section>
<!--End Hidden Bar -->
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-12 col-lg-8">
                                                            <div class="main-slider__content">
                                                                <img src="images/logo aj.png" alt="" title="Delici - AJ Foods">
                                                                <h3 class="main-slider__title" style="font-family: 'Zeyada', serif; font-size: 48px;">For of him, And through him, And to him,<br>Are all things, to whom be glory for ever</h3>
                ...
                <div class="text-col col-xl-5 col-lg-5 col-md-12 col-sm-12">
                    <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="title-box centered">
                            ...
                            <h2>We Give you the taste of kerala</h2>
                            <div class="text">We have built AJ Foods on trust by listening carefully to the needs and feedback of our customers. Our goal is to let you enjoy your party. We aim to always exceed your expectations as far as taste, presentation and service.We use only the finest and freshest ingredients to give you a truly elevated dining experience in the comfort of your own home or office.AJ Foods has an outstanding team of professional chefs that make every dish from scratch.</div>
                        </div>
                        <div class="booking-info">
                ...
                <div class="image-col col-xl-7 col-lg-7 col-md-12 col-sm-12">
                    <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                        ...
                        <div class="images parallax-scene-1">
                            <div class="image" data-depth="0.15"><img src="images/whowe.png" alt=""></div>
    ...
    <section class="services-section">
        ...
        <div class="auto-container">
            <div class="title-box centered">
                <div class="subtitle"><span>Make it special</span></div>
                <div class="pattern-image"><img src="images/icons/separator.svg" alt="" title=""></div>
                <h2>Our Services</h2>
            </div>
            <div class="row clearfix" >
                <div class="s-col col-lg-6 col-md-6 col-sm-12" style="text-align:center;">
                    <div class="inner wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="s-block">
                            <div class="inner">
                                <div class="icon-box"><img src="images/resource/s-icon-1.png" alt="" title=""></div>
                                <h4>Corporate Events</h4>
                                <img src="images/resource/service-image copy1.jpg" alt="" title="">
                                <div class="text">Our goal is to create once in a lifetime events for our clients and their guests.</div>
                            </div>
                        </div>
                        <div class="s-block alternate">
                            <div class="inner">
                                ...
                                <img src="images/resource/service-image copy1.jpg" alt="" title="">
                                <div class="text">To deliver and execute unparalled live events through creative and unconventional experiences</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="inner wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="0ms">
                        <div class="s-block alternate">
                            <div class="inner">
                                ...
                                <h4>Birthday Functions</h4>
                                <img src="images/resource/service-image copy1.jpg" alt="" title="">
                                <div class="text">what is important to you and to picture what you envision</div>
                            </div>
                        </div>
                        <div class="s-block">
                            <div class="inner">
                                <div class="icon-box"><img src="images/resource/s-icon-4.png" alt="" title=""></div>
                                <h4>Baptism Function</h4>
                                <img src="images/resource/service-image copy1.jpg" alt="" title="">
                                <div class="text">we give you our full support for a seamless experience.</div>
                            </div>
                        </div>
    ...
    <section class="we-offer-section">
        ...
        <div class="auto-container">
            ...
            <section class="testimonials-section" style="background:none; max-height: 1000px; max-width:2000px;">
        <div class="image-layer"></div>
        <div class="auto-container" style="max-width:2000px;">
            <div class="carousel-box">
                <div class="">
                <div class="separator"><span></span><span></span><span></span></div>
                <div class="thumbs-carousel-box" style="max-width:2000px;">
                    <!--block-->
                    <div class="testi-thumbs owl-theme owl-carousel">
                        ...
                        <h4><a href="menu-list-1.html">Easy store</a></h4>
                    ...
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        ...
                        <h4><a href="menu-list-2.html">Kinder Hospital</a></h4>
                    ...
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="600ms">
                        ...
                        <h4><a href="menu-list-3.html">PVR Cinemas</a></h4>
...
<section class="testimonials-two">
	...
	<div class="auto-container">
		...
		<div class="title-box centered">
			<div class="subtitle"><span>What People Are Saying</span></div>
			<div class="pattern-image"><img src="images/icons/separator.svg" alt="" title=""></div>
			...
			<div class="testimonial-slider owl-theme owl-carousel">
				...
				<div class="testi-block">
					<div class="inner-box">
						...
						<div class="text">The taste of food was really amazing,  I never forget this delicious food experience.</div>
						<div class="auth-info">
				...
				<div class="testi-block">
					<div class="inner-box">
						<div class="quote-icon"><img src="images/icons/quotes-1.png" alt="" title=""></div>
						<div class="rating"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></div>
						<div class="text">Hygienic food & fresh enviroment, everyone had a wonderful delite experience. It was FABULOUS! great experience .</div>
						<div class="auth-info">
				...
				<div class="testi-block">
					<div class="inner-box">
						<div class="quote-icon"><img src="images/icons/quotes-1.png" alt="" title=""></div>
						<div class="rating"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></div>
						<div class="text">Special treat to dine, It was wow experience food was really delicious! </div>
						<div class="auth-info">
				...
				<div class="testi-block">
					<div class="inner-box">
						<div class="quote-icon"><img src="images/icons/quotes-1.png" alt="" title=""></div>
						<div class="rating"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></div>
						<div class="text">TVery experienced working with different cultures,they know exactly how to make the event asuccesful.without a doubt,the best wedding planner in kerala.</div>
						<div class="auth-info">
							<div class="image"><img src="images/resource/author-thumb-4.jpg" alt=""></div>
							<div class="auth-title">willium joe</div>
				...
				<div class="testi-block">
					<div class="inner-box">
						<div class="quote-icon"><img src="images/icons/quotes-1.png" alt="" title=""></div>
						<div class="rating"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></div>
						<div class="text">Thank you so much for everything! The event was ascuccess thanks to you and the efforts put forth by your team"</div>
						<div class="auth-info">
							<div class="image"><img src="images/resource/author-thumb-6.jpg" alt=""></div>
							<div class="auth-title">Michel Byrd</div>
							<div class="location"></div>
                ...
                <div class="testi-top owl-theme owl-carousel">
                    <div class="slide-item">
                        <div class="slide-content">
                            ...
                            <div class="text quote-text">Very experienced working with different cultures,they know exactly how to make the event asuccesful.without a doubt,the best wedding planner in kerala.</div>
                        </div>
                    </div>
                    <div class="slide-item">
                        <div class="slide-content">
                            <div class="quotes">”</div>
                            <div class="text quote-text">Thank you so much for everything! The event was ascuccess thanks to you and the efforts put forth by your team"</div>
                        </div>
                    </div>
